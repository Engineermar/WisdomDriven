# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2018-12-03 23:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry', models.CharField(choices=[(1, 'fuel'), (2, 'nondurable manfacturer'), (3, 'tech'), (4, 'retail'), (5, 'wholesale trade'), (6, 'state_military_federal'), (7, 'other')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license', models.CharField(choices=[('A', 'class a'), ('B', 'class b'), ('C', 'class c')], max_length=50, null=True)),
                ('other_license', models.CharField(choices=[('A', 'class a'), ('B', 'class b'), ('C', 'class c')], max_length=50, null=True)),
                ('other_license_2', models.CharField(choices=[('A', 'class a'), ('B', 'class b'), ('C', 'class c')], max_length=50, null=True)),
                ('license_number', models.IntegerField(null=True)),
                ('date_hired', models.DateField(null=True)),
                ('company_id', models.ForeignKey(null='True', on_delete=django.db.models.deletion.CASCADE, related_name='driver_id', to='wdapp.Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beginnning_weather_conditions', models.CharField(choices=[(1, 'normal'), (2, 'cloudy'), (3, 'rain'), (4, 'snow'), (5, 'hazardous'), (6, 'extremly hazardous')], max_length=50, null=True)),
                ('midway_weather_conditions', models.CharField(choices=[(1, 'normal'), (2, 'cloudy'), (3, 'rain'), (4, 'snow'), (5, 'hazardous'), (6, 'extremly hazardous')], max_length=50, null=True)),
                ('ending_weather_conditions', models.CharField(choices=[(1, 'normal'), (2, 'cloudy'), (3, 'rain'), (4, 'snow'), (5, 'hazardous'), (6, 'extremly hazardous')], max_length=50, null=True)),
                ('fuel_card_usage', models.CharField(choices=[('Yes', 'yes'), ('No', 'no')], max_length=50, null=True)),
                ...
                ('driver_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trips_driver_id_set', to='wdapp.BusinessOrder')),
